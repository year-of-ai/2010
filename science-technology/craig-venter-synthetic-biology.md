...
# J. Craig Venter and Synthetic Biology Leadership in 2010
...
- Wikipedia: [J. Craig Venter](https://en.wikipedia.org/wiki/J._Craig_Venter) — biographical information and career trajectory
- Wikipedia: [JCVI-syn1.0](https://en.wikipedia.org/wiki/Synthia) — comprehensive explanation of the synthetic cell and its significance
...
- [First synthetic cell (JCVI-syn1.0)](synthetic-cell-jcvi-syn1.md) — primary entry on the synthetic cell itself, with technical detail on the genome construction and cellular biology
- [Stuxnet cyberweapon discovered](stuxnet.md) — parallel 2010 milestone: both Stuxnet and JCVI-syn1.0 demonstrated that digital information could control physical-world systems (computers and cells, respectively), raising parallel governance questions
- [iPad launch](ipad-launch.md) — simultaneous 2010 technology milestone; Apple's consumer-facing announcement on January 27 attracted more media attention than any other 2010 tech event, but Venter's May 20 publication arguably represented a more consequential long-term technological shift
- [Google announces withdrawal from China](google-china-withdrawal.md) — fellow 2010 event reshaping the relationship between technology, governance, and national sovereignty
