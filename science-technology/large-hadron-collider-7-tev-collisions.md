---
title: "Large Hadron Collider — First 7 TeV Collisions"
date: 2010-03-30
category: "Science & Technology"
---

# Large Hadron Collider — First 7 TeV Collisions
...
- [First LHC collisions at 7 TeV — CERN Timeline](https://timeline.web.cern.ch/first-lhc-collisions-7-tev) — CERN's official record of the 30 March 2010 milestone.
- [Large Hadron Collider — Wikipedia](https://en.wikipedia.org/wiki/Large_Hadron_Collider) — encyclopedic overview of the collider, its energy records, and its four main experiments.
- [LHC research programme launched with 7 TeV collisions — Symmetry magazine](https://www.symmetrymagazine.org/breaking/2010/03/30/lhc-research-program-launched-with-7-tev-collisions) — contemporaneous specialist reporting, including the CERN Director-General's remarks and the planned run length.
- [CERN sets date for first attempt at 7 TeV collisions in the LHC — CERN press release](https://home.cern/news/press-release/cern/cern-sets-date-first-attempt-7-tev-collisions-lhc) — official announcement of the collision attempt and its physics goals.

## Related

- [Graphene and the 2010 Nobel Prize in Physics](graphene-nobel-prize-physics-2010.md) — a contemporaneous 2010 landmark in fundamental physics, recognized the same year the LHC opened its research programme
- [First Self-Replicating Synthetic Cell (JCVI-syn1.0)](synthetic-cell-jcvi-syn1.md) — a parallel 2010 milestone of large-scale, capital-intensive experimental science pushing a physical frontier
- [Kepler-9 Multi-Planet Transiting System](kepler-9-exoplanet-discovery.md) — another 2010 result from a flagship scientific instrument extending the reach of observation
